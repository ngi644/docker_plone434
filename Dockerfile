############################################################
# Dockerfile to run plone 4.3.4 Containers
...
USER plone
WORKDIR /home/plone
RUN wget https://launchpad.net/plone/4.3/4.3.4/+download/Plone-4.3.4-UnifiedInstaller.tgz
RUN tar zxvf Plone-4.3.4-UnifiedInstaller.tgz
WORKDIR Plone-4.3.4-UnifiedInstaller
RUN ./install.sh standalone --target=/home/plone/plone4_3_4 --password=admin

#start plone
USER root
CMD su plone -c '/home/plone/plone4_3_4/zinstance/bin/instance start' && /usr/sbin/sshd -D
